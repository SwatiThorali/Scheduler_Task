...
export let scheduleData: Record<string, any>[] = [
  ...
  export let leaveData: Record<string, any>[] = [
    {
      ...
      StartTime: new Date(2021, 10, 18),
      EndTime: new Date(2021, 10, 18)
    }, {
      Id: 2,
      Subject: 'Sick Leave',
  ...
  export let roomData: Record<string, any>[] = [
    ...
    },
    {
      Id: 56,
      Subject: 'Lunch Break',
      StartTime: new Date(2022, 10, 2, 13, 0),
      EndTime: new Date(2021, 10, 2, 14, 0),
  ...
  export let blockData: Record<string, any>[] = [
    {
      ...
      StartTime: new Date(2022, 10, 23,8,0),
      EndTime: new Date(2022, 10, 23, 12, 0),
      IsAllDay: false,
      IsBlock: false,
      EmployeeId: 1,
      Start:true
      ...
      StartTime: new Date(2022, 10, 18, 14, 0),
      EndTime: new Date(2022, 10, 18, 16, 0),
      IsAllDay: false,
      IsBlock: true,
      EmployeeId: 2
    }, {
      Id: 3,
      Subject: 'Sick Leave',
      StartTime: new Date(2022, 10, 23),
      EndTime: new Date(2022, 10, 23),
      IsAllDay: true,
      IsBlock: true,
      EmployeeId: 3
    }, {
      Id: 4,
      Subject: 'Client Meeting',
      StartTime: new Date(2022, 10, 23, 12, 0),
      EndTime: new Date(2022, 10, 23, 16, 0),
      IsAllDay: false,
      IsFirstHalf: false,
      IsBlock: false,
      IsSecondHalf:true,
      ...
      Id: 9,
      Subject: 'Client Meeting',
      StartTime: new Date(2022, 10, 18, 8, 0),
      EndTime: new Date(2022, 10, 18, 10, 30),
      IsAllDay: false,
      EmployeeId: 3
    }, {
      Id: 10,
      Subject: 'Conference',
      StartTime: new Date(2022, 10, 18, 13, 30),
      EndTime: new Date(2022, 10, 18, 15, 0),
      IsAllDay: false,
      EmployeeId: 4
    }, {
      Id: 11,
      Subject: 'Employee Recruitment',
      StartTime: new Date(2022, 10, 18, 10, 0),
      EndTime: new Date(2022, 10, 18, 13, 0),
      IsAllDay: false,
      EmployeeId: 5
    }, {
      Id: 12,
